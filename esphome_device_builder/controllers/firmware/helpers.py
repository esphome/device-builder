...
Free functions only — no controller state. Used inside
``controller.py`` and exercised in isolation by tests under
``tests/controllers/firmware/test_helpers.py``. The sibling-CLI
resolvers live in ``helpers/sibling_cli.py``.
"""
