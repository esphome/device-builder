...
**Implementation slice 7b — offloader Settings UI backend.** The transparent install flow ships dark — no user-visible knob to gate, disable, or steer the routing decision — until the 7b backend lands the surfaces the Settings UI binds to.
